...
const SentRequestDetailScreen = ({navigation, route}: any) => {
  ...
  const username =
    request.mateUsername ??
    deriveMateUsername(request.mateName, request.mateTenureId);
      ...
      <View style={[styles.container, {paddingTop: insets.top + 8}]}>
        ...
        <ScrollView
          ...
          contentContainerStyle={[
            styles.scroll,
            {paddingBottom: insets.bottom + (canCancel ? 100 : 40)},
          ]}>
          <View style={styles.heroCard}>
            <View style={styles.heroTop}>
              ...
              <View style={styles.heroInfo}>
                ...
                <Text style={styles.meta}>{genderLabel}</Text>
            ...
            <Pressable
              ...
              onPress={() =>
                showAlert({
                  title: 'Message',
                  message: 'Chat opens after they accept your request.',
                })
              }>
          ...
          <View style={styles.requestDetailsCard}>
            <Text style={styles.requestSectionTitle}>Location</Text>
            <Text style={styles.requestLocation}>{request.meetLocation}</Text>
        ...
        {canCancel ? (
          <View
            ...
            <Pressable
              style={styles.cancelMateBtn}
              onPress={handleCancelRequest}>
              <Text style={styles.cancelMateText}>Cancel Mate Request</Text>
            </Pressable>
          </View>
        ) : null}
      </View>
