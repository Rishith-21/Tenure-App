...
const SocialLinkSheet = ({
  ...
  const isEdit = Boolean(initialUrl?.trim());
  ...
  }, [visible, platform?.id, initialUrl]);
    ...
    <BottomSheetModal visible={visible} onClose={onClose}>
      <Pressable style={styles.sheet} onPress={() => {}}>
        ...
        <Text style={styles.title}>
          {platform.icon} {platform.label} {isEdit ? 'link' : 'profile'}
        </Text>
        <Text style={styles.subtitle}>
          {isEdit
            ? 'Update your public profile link or username'
        ...
        <Pressable
          ...
          <Text style={styles.primaryBtnText}>
            {confirmLabel ?? (isEdit ? 'Save link' : 'Add link')}
          </Text>
        </Pressable>
